<template>
  <div>
    <div class="content-top">
      <el-form :inline="true" label-width="70px">
        <el-form-item label="搜索">
          <el-input v-model="queryParams.queryName" placeholder="标签名称" clearable @keyup.enter="getPage" maxlength="30" />
        </el-form-item>
    ...
    <div class="content-main">
      <el-table row-key="id" :data="pageData" style="width: 100%" stripe v-loading="loading" max-height="650" show-overflow-tooltip>
