    ...
    <div class="content-top">
      <el-form :inline="true" label-width="70px">
        <el-form-item label="搜索">
          <el-input v-model="queryParams.queryName" placeholder="短信内容" clearable @keyup.enter="search" maxlength="30" />
        </el-form-item>
        <el-form-item>
    ...
    <div class="content-main">
      <el-table :data="pageData" style="width: 100%" stripe v-loading="loading" max-height="660" show-overflow-tooltip>
        ...
        <el-table-column label="操作" fixed="right" width="100">
          <template #header>
            <span style="margin-right: 5px">操作<QuestionTip content="注意：短信模板的变更不会立即生效，需刷新缓存才能生效"/></span>
          </template>
...
const pageData = ref([]);
const formRef = ref();
const selectAuth = userStore.hasAuth('pkR0');
