  ...
  <div>
    <div class="content-top">
      <el-form :inline="true" label-width="70px">
        <el-form-item label="搜索">
          <el-input v-model="queryParams.queryName" placeholder="昵称、设备序列号、访问地址、访问IP" clearable @keyup.enter="search" style="width: 300px" maxlength="30" />
        </el-form-item>
    ...
    <div class="content-main">
      <el-table :data="pageData" style="width: 100%" stripe v-loading="loading" max-height="650" show-overflow-tooltip>
        ...
        <el-table-column prop="requestParam" label="请求参数" min-width="250" />
