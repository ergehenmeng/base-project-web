  ...
  <div>
    <div class="content-top">
      <el-form :inline="true" label-width="70px">
        ...
        <el-form-item class="right-button" v-has-perm="'owO0'">
...
<script setup>
import { deleteApi, listPageApi, exportApi, platformUnShelvesApi, shelvesApi, unShelvesApi } from '@/api/product/venue';
