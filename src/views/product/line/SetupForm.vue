    ...
    <el-form :model="formData" ref="formDataRef" :rules="formRules" label-position="right" label-width="auto" v-loading="loading">
      <el-form-item label="设置日期" prop="configDate">
        <div style="width: 400px">
          <el-date-picker type="daterange" value-format="YYYY-MM-DD" :disabled-date="disableBeforeDate" v-model="formData.configDate" style="width: 400px"></el-date-picker>
        </div>
      </el-form-item>
      <el-form-item label="周期" prop="week" class="w480">
      ...
      <el-form-item label="划线价" class="w480">
      ...
      <el-form-item label="销售价" prop="salePrice" class="w480">
      ...
      <el-form-item label="库存" prop="stock" class="w480">
