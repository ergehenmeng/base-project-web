...
<script setup>
import { createApi, selectApi, updateApi } from '@/api/product/travel';
...
const formRules = reactive({
  title: [{ required: true, message: '旅行社名称不能为空', trigger: 'blur' }],
  logoUrl: [{ required: true, message: '请上传旅行社logo', trigger: 'change' }],
