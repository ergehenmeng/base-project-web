    ...
    <div class="content-top">
      <el-form :inline="true" label-width="70px" >
        <el-form-item label="搜索">
          <el-input v-model="queryParams.queryName" placeholder="订单编号、餐饮券名称、餐饮店、手机号" clearable @keyup.enter="search" style="width: 280px;"/>
        </el-form-item>
      ...
      <el-table :data="pageData" style="width: 100%" stripe v-loading="loading" max-height="670" show-overflow-tooltip>
        ...
        <el-table-column label="操作" fixed="right" width="200">
          <template #default="scope">
            <el-button v-has-perm="'dpD0'" type="info" :icon="Document" @click="handleDetail(scope.row)" link title="详情">
            </el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script setup>
import { listPageApi } from '@/api/order/voucher';
