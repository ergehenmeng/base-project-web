  ...
  <div class="edit-content">
    ...
    <el-form :model="formData" ref="formDataRef" :rules="formRules" label-position="right" label-width="auto" v-loading="loading" :disabled="disabled">
      ...
      <el-form-item label="商品信息" prop="itemIds">
        ...
        <QuestionTip content="注意：限时购活动只支持零售类商品，且商品只能参加一个活动" ></QuestionTip>
      </el-form-item>
      ...
      <el-form-item label="备注" prop="remark">
        <el-input type="textarea" :autosize="{ minRows: 4, maxRows: 6 }" v-model="formData.remark" maxlength="100" show-word-limit />
      </el-form-item>
    </el-form>
    <div>
