      ...
      <el-table :data="pageData" style="width: 100%" stripe v-loading="loading" max-height="670" show-overflow-tooltip>
        ...
        <el-table-column prop="imgUrl" label="预览" width="100">
          <template #default="scope">
            <div style="display: flex; align-items: center">
              <el-image fit="contain" :src="scope.row.imgUrl" :preview-src-list="[scope.row.imgUrl]"
        ...
        <el-table-column label="操作" fixed="right">
          <template #default="scope">
            ...
            <el-button v-has-perm="'mxU0'" type="danger" :icon="Delete" @click="handleDelete(scope.row)" link
              title="删除">
            </el-button>
          </template>
        </el-table-column>
