...
const formRules = reactive({
  showValue: [{ required: true, message: '显示值不能为空', trigger: 'blur' }],
  hiddenValue: [{ required: true, message: '隐藏值不能为空', trigger: 'blur' }]
});
